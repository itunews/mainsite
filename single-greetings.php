...
<div class="row">    
    ...
    <div class="col l4 push-l1"> <!--IND: create a column 4/12th the width of the parent container -->
      ...
      <a href="https://www.itu.int/en/ITU-T/academia/kaleidoscope/2017/Pages/default.aspx"><img class="responsive-img storyfirstadd wow appear-from-bottom element-animated" srcset="<?php echo get_template_directory_uri() . '/media/kaleidoscope_2017_web_banner.jpg'; ?>" src="<?php echo get_template_directory_uri() . '/media/kaleidoscope_2017_web_banner.jpg'; ?>"></a> <!--IND: add your image URI here -->
