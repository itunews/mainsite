...
<html <?php language_attributes(); ?>>
  <head>
    <meta charset="<?php bloginfo('charset'); ?>"><meta property="og:site_name" content="ITU News"><meta name='medium' content='blog'><meta name="language" content="english"><meta name="distribution" content="global"><meta name="author" content="ITU"><meta name="robots" content="index, follow"><meta name="revisit-after" content="5 days"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="theme-color" content="#1E88E5" /><meta name="msapplication-TileColor" content="#2196F3"><meta name=viewport content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no"><meta name="HandheldFriendly" content="True"><meta name="MobileOptimized" content="320"><meta name="apple-mobile-web-app-title" content="ITUNews"><meta name="mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="#2196F3"><meta name="msapplication-navbutton-color" content="#2196F3">

    <link rel="icon" href="/yts/img/favicon_32-vfl8NGn4k.png" sizes="32x32">

    <link rel="icon" href="/yts/img/favicon_48-vfl1s0rGh.png" sizes="48x48">

    <link rel="icon" href="/yts/img/favicon_96-vfldSA3ca.png" sizes="96x96">

    <link rel="icon" href="/yts/img/favicon_144-vflWmzoXw.png" sizes="144x144">
  ...
  <div class="col l12">
    <div class="modal-content">
      <form role="search" method="get" id="searchform" class="searchform" action="http://news.itu.int/" _lpchecked="1">
        <div>
        <input type="text" value="" name="s" id="s">
          <input class="btn" type="submit" id="searchsubmit" value="Search">
                   <a style="position: absolute;right: 10em;top: 8em;" href="#!" class="modal-action modal-close">Cancel</a>
        </div>
      </form>
      ...
      <a href="#modalsearch"><img class="searchicon right" srcset="<?php echo get_template_directory_uri() . '/media/searchicon-01.svg'; ?>"></a>
          ...
          <div class="z-depth-3 bluenavbar">

                  <div class="menuitems container hide-on-large-only">
              ...
              <div class="menuitems container hide-on-med-and-down">
                   ...
                   <a href="#"><span class="right" style="margin-right: 1em;">Managers</span></a>

             <a href="#"><span style="margin-right: 1em;" class="right">IT Admin</span></a>
